          ...
          <div className="container-lg nav-parent" style={navparentStyle}>
            <div id="#documentElement" className="nav-col middle">
              <div
                ...
                style={{
                  willChange:
                    "width, height, background-color: (0, 0%, 100%), width: var(--scrollPosition), height: 100%",
                }}
              ></div>
              <div
                className="frost ab-bl"
                style={{
                  transform:
                    "translate3d(0%, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d",
                }}
              ></div>
              <div className="logo-pop-out"></div>
              <a
                aria-label="Home"
                data-w-id="a34d7e2a-6311-e67e-5390-cdddda6d14a4"
                href="/"
                aria-current="page"
              ...
              >
                ...
                <div
                  id="muteButton"
                  data-w-id="a34d7e2a-6311-e67e-5390-cdddda6d14a6"
                  className="sound"
                  style={{
                ...
                >
                  <div
                    ...
                    data-w-id="a34d7e2a-6311-e67e-5390-cdddda6d14a7"
                  ...
                  >
                    ...
                    >
                      ...
                      <g clip-path="url(#__lottie_element_54)">
                        <g
                          transform="matrix(1,0,0,1,8.375,5.75)"
                          opacity="1"
                          style={{ display: "block" }}
                        >
                        ...
                        <g
                          transform="matrix(1,0,0,1,11.5,5.75)"
                          opacity="1"
                          style={{ display: "block" }}
                        >
                          <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                            <path
                              ...
                              stroke-opacity="1"
                              stroke-width="2"
                              d=" M-6.375,-5 C-6.375,-5 -6.375,6.125 -6.375,6.125"
                            ></path>
                          </g>
                        </g>
                        <g
                          transform="matrix(1,0,0,1,14.468999862670898,5.75)"
                          opacity="1"
                          style={{ display: "block" }}
                        >
                          <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                        ...
                        <g
                          transform="matrix(1,0,0,1,17.312000274658203,5.75)"
                          opacity="1"
                          style={{ display: "block" }}
                        >
                          <g opacity="1" transform="matrix(1,0,0,1,0,0)">
            ...
            <div className="nav-col">
              <div
                className="border-line-top intro"
                style={{ width: "100%", height: "1px" }}
              ></div>
              <div
                className="border-line-right intro"
                style={{ width: "1px", height: "100 %" }}
              ></div>
              <div
                className="border-line-btm-right intro"
                style={{ width: "100 %", height: "1px" }}
              ></div>
              <a
                href="/about"
                className="nav-button bg w-inline-block"
                style={{ opacity: 1 }}
              >
                <div className="div-hide intro">
                  <div
                    ...
                    style={{
                      transform:
                        "translate3d(0, px, 0%) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
                      transformStyle: "preserve-3d",
                    }}
                  >
                    ABOUT
                  ...
                  <div
                    ...
                    style={{
                      transform:
                        "translate3d(0px, 0px, -100%) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
                      transformStyle: "preserve-3d",
                    }}
                  >
                    ABOUT
              ...
              <div className="size-two">
                <a
                  href="https://www.fates.world/divisions"
                  target="_blank"
                ...
                <a
                  href="https://twitter.com/fates_world"
                  rel="noopener"
                  target="_blank"
                  className="nav-button w-inline-block"
                  style={{ opacity: 1 }}
