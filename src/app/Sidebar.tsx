...
const Sidebar: React.FC<ISidebar> = ({ open, setOpen }) => {
    ...
    return (
        <div className={`${open ? "translate-x-0" : "translate-x-[-100%]"} bg-foreground3 w-[250px] border-r h-full shadow-2xl fixed transition duration-300 z-50`}>
            <div className="flex justify-between items-center border-b p-3">
                ...
                <Button onClick={() => setOpen(false)} className="h-9 w-9 rounded-full flex justify-center items-center p-0 bg-transparent hover:bg-lightWhite3 text-white3">
