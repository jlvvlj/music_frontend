...
const Sidebar: React.FC<ISidebar> = ({ open, setOpen }) => {
    return (
        <div>
            <div className={`lg:block hidden bg-[#060606] w-[250px] border-r h-screen shadow-2xl fixed transition duration-500 z-50`}>
                <div className="flex items-center text-lg font-medium text-white border-b p-3">
            ...
            <div className={`${open ? "translate-x-0" : "translate-x-[-100%]"} bg-[#060606] w-[250px] border-r h-screen shadow-2xl fixed transition duration-500 z-50`}>
