...
import Tracks from "@/hooks/tracks";
  ...
  return (
    <React.Fragment>
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList>
          <TabsTrigger value="overview" onClick={handleTabClick}>
            Overview
          </TabsTrigger>
          <TabsTrigger value="analytics" onClick={handleTabClick}>
            {" "}
            Streams
          </TabsTrigger>
          <TabsTrigger value="revenue" onClick={handleTabClick}>
            Revenue
          </TabsTrigger>
          <TabsTrigger value="viewone" onClick={handleTabClick}>
            View One
          </TabsTrigger>
        </TabsList>
        <TabsContent value="overview" className="space-y-4">
            ...
            <Card className="flex flex-col justify-between">
              <CardHeader className="flex flex-col justify-between space-y-0 pb-2">
                ...
                <div className="text-2xl font-bold">
                  ${trackTotalStreams?.monthlyStreamsRevenue || 0}
                </div>
              ...
              <CardContent>
                <div className="h-[80px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart
                      data={trackTotalStreams?.chartData || []}
                      margin={{
                        top: 5,
                        right: 10,
                        left: 10,
            ...
            <Card className="flex flex-col justify-between">
              ...
              <CardContent>
                <div className="mt-4 h-[90px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={trackTotalStreams?.chartData || []}>
                      <Bar
          ...
          <div className="grid gap-4 md:grid-cols-2 2xl:grid-cols-7">
            <Card className="col-span-3">
              ...
              <CardContent>
                <RecentSales userTracks={userTracks} />
              </CardContent>
            </Card>
            <div className="col-span-4 grid gap-4 grid-cols-2 ">
              <Card className="flex flex-col justify-between">
                ...
                <CardContent className="p-6">
                  <CardDescription>
                    Your contract for Fields of Dreams is nearly done! Click
                    below to complete the last steps.
                  </CardDescription>
              ...
              <CardsActivityGoal />
              <CardsTeamMembers userFriends={userFriends} />
              <CardsChat />
            </div>
          </div>
        </TabsContent>
        <TabsContent value="viewone" className="pt-6 space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  className="lucide lucide-disc-album"
                >
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                >
                  <circle className="bg-red-500" cx="12" cy="12" r="10" />
          ...
          <div className="grid gap-4 md:grid-cols-2 2xl:grid-cols-7">
            ...
            <Card className="col-span-3">
              <CardHeader>
                <CardTitle>Top Tracks</CardTitle>
                <CardDescription>Your best tracks by revenue.</CardDescription>
              </CardHeader>
              <CardContent>
                <RecentSales />
              </CardContent>
