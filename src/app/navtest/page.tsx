...
export default function Nav() {
    ...
    const position = y ? y / 15 : 0;

    const navWidth = position?.toString() + "%";

    console.log(navWidth);

    return (
        <div
            className="background mt-24"
        >
                ...
                <div className="container-lg nav-parent" style={navparentStyle}>
                    <div id="#documentElement" className="nav-col middle">
                        ...
                        <div className="frost ab-bl"
                            style={{ backgroundColor: 'rgba(255, 255, 255, 0.3)', width: navWidth, transform: 'translate3d(0%, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d' }}>
                        </div>
