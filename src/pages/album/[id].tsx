...
import Record from '../music/components/Record'
import { Layout } from '../music/components/layout'
                                    ...
                                    return (
                                        <li
                                            ...
                                            onClick={() => {
                                                ...
                                                if (isCurrentTrack && isPlaying === true) setIsPlaying(false)
                                        ...
                                        >
                                            <span className="text-gray-500 w-8 mr-2">
                                                ...
                                                {isCurrentTrack && !isPlaying ? playIcon : isCurrentTrack && isPlaying ? pauseIcon : track.position}
                                            </span>
